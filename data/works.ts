...
export const works: Work[] = [
  {
    id: "specimens-of-daily-actions",
    title: "生活所作標本 / Specimens of Daily Actions",
    category: "Graphic Design",
    description: "Field Recording Album & Archive",
    imageUrl: "/img/specimens-of-daily-actions/01.jpg",
    images: [
      "/img/specimens-of-daily-actions/01.jpg",
      "/img/specimens-of-daily-actions/02.jpg",
      "/img/specimens-of-daily-actions/03.jpg",
      "/img/specimens-of-daily-actions/04.jpg",
      "/img/specimens-of-daily-actions/05.jpg",
      "/img/specimens-of-daily-actions/06.jpg",
      "/img/specimens-of-daily-actions/07.jpg",
      "/img/specimens-of-daily-actions/08.jpg",
      "/img/specimens-of-daily-actions/09.jpg",
    ],
    technologies: ["Field Recording", "Audio"],
    details: {
      overview: {
        ja: "効率化の追求によって失われつつある「行為のプロセス」そのものの価値を再発見するためのフィールドレコーディングアルバム作品。同一の目的を果たす「合理的」な手段と「合理的でないとされた手段」をそれぞれ録音対象とし、『生活合理所作標本』および『生活所作標本』という2枚のアルバムとして構築された。収録音源には行為を細分化してテキスト化した同期歌詞が含まれ、比較聴取を通じて手段やプロセスの手触りに目を向けるきっかけを提供する。",
        en: "A field recording album project created to rediscover the intrinsic value of 'action processes' lost in the pursuit of excessive efficiency. By selecting both 'optimized' (rational) methods and 'methods considered non-rational' that achieve the same daily objective, two field recording albums were produced: Specimens of Optimized Daily Actions and Specimens of Daily Actions. Synchronized lyric texts detailing each action step are embedded in the tracks, inviting listeners to reflect on procedural nuances through comparative listening.",
      },
      concept: {
        ja: "現代社会における過度な効率化は、体験の過程や手触りに対する感覚を薄れさせている。本作では、同一タイトル（目的）のトラックにおいて「合理的」な手段と「合理的でないとされた手段」という異なる方法で録音された音を対比させることで、単なる効率の良し悪しを超えた「プロセスの手触り」を可視化・可聴化する。レコーディングとアーカイブという手法を通して、失われつつある日常の行為そのものに新たな価値と視点を与える。",
        en: "Excessive optimization in modern society often diminishes our awareness of experiential processes and tactile nuance. By contrasting soundscapes generated by rational methods versus methods considered non-rational under identical track titles, this work visualizes and auditizes the subtle texture of human actions beyond pure efficiency. Through field recording and archiving, it imbues daily habits with new perspectives and quiet value.",
      },
    },
  },
  {
